...
file_to_load = os.path.join(f"C:/Users/pampe/Desktop/Election-Analysis/election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join(f"C:/Users/pampe/Desktop/Election-Analysis/election_analysis.txt")
